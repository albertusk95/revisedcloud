...
<body>
	...
	<div class="jumbotron">
	<h2>System Log by Admin</h2>
		<?php echo form_open("cloud/cek_systemlog"); ?>
			Masukan nomor ID yang ingin di lihat track record nya :
				<input type="text" name="noidlog">
				<input type="submit" name="nomoridlog" value="Start tracking">
